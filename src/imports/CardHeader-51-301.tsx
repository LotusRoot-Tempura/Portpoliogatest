...
import imgImage from "figma:asset/8416f51fc998dcdd53eda79631a3fcd5fd89f225.png";
  ...
  return (
    <BackgroundImage16>
      <div className="box-border content-stretch flex flex-col gap-1 items-start justify-start p-0 relative">
        <BackgroundImage text="대학교(학사)" text1="|" text2="인문계" />
        <BackgroundImage text="2013.02" text1="~" text2="2015.02" />
      </div>
    </BackgroundImage16>
  );
}
